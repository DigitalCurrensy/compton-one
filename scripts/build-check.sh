...
for f in index.html compton-one-fix.html bundle.js app.js app.langs.js app.ui.js; do
...
echo "3/6 HTML loads the four scripts"
...
! grep -q 'PLACEHOLDER' app.js app.langs.js app.ui.js index.html
