...
for f in index.html compton-one-fix.html bundle.js app.js app.ui.js; do
  test -f "$f" || { echo "MISSING: $f"; exit 1; }
done

echo "2/6 controller syntax check"
node --check app.js
node --check app.ui.js

echo "3/6 HTML loads the three scripts"
...
! grep -q 'PLACEHOLDER' app.js app.ui.js index.html
